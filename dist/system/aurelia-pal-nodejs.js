...
System.register(['aurelia-pal', 'jsdom', 'events'], function (_export, _context) {
  "use strict";

  var initializePAL, jsdom, EventEmitter, _typeof, isInitialized, NodeJsDom, NodeJsFeature, NodeJsMutationEmulator, NodeJsMutationObserver, NodeJsPlatform;
  ...
  return {
    ...
    execute: function () {
      ...
      _export('NodeJsDom', NodeJsDom = function () {
      ...
      _export('NodeJsDom', NodeJsDom);

      _export('NodeJsFeature', NodeJsFeature = function NodeJsFeature(global) {
      ...
      _export('NodeJsFeature', NodeJsFeature);

      _export('NodeJsMutationEmulator', NodeJsMutationEmulator = function () {
      ...
      _export('NodeJsMutationEmulator', NodeJsMutationEmulator);

      _export('NodeJsMutationObserver', NodeJsMutationObserver = function () {
      ...
      _export('NodeJsMutationObserver', NodeJsMutationObserver);

      _export('NodeJsPlatform', NodeJsPlatform = function () {
      ...
      _export('NodeJsPlatform', NodeJsPlatform);
    }
  };
});